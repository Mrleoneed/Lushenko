...
let ar2 = ['Vera', 'Eva', 'Leo', 2, 10, 11, false]
...
function f8() {
	...
	for (let i = 0; i < ar8.length; i++) {
		out1.innerHTML += ar8[i] + "-"
		out2.innerHTML = "Длина массива = " + ar8.length
	}
}
...
function f9() {
	...
	out.innerHTML = ar9[ar9.length - 1]
}
...
function f16() {
	...
	for (let i = 0; i < ar16_odd.length; i++) {
		odd_str += ar16_odd[i] + ' '; // собираем строку из элементов массива ar16_odd, разделенных пробелами
	}

	for (let i = 0; i < ar16_even.length; i++) {
		even_str += ar16_even[i] + ' '; // собираем строку из элементов массива ar16_even, разделенных пробелами
	}

	out16_odd.innerHTML = odd_str;
	out16_even.innerHTML = even_str;
}
