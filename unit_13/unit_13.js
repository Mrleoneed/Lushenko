...
function f6() {
	let inputValue1 = document.querySelector('.i-61').value;
	let inputValue2 = document.querySelector('.i-62').value;
	a6[inputValue1] = inputValue2
	f5(a6, ".out-6")
}
