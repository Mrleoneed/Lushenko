...
function f4() {
	...
	let check = document.querySelector(".i-4").checked
	out.innerHTML = check;
}
...
function f8() {
	...
	out.innerHTML = "<input class='i-81'><button class='b-81'>Click</button>"
...
function f9() {
	...
	let input = document.querySelector(".r-9").checked;
	if (input == true) {
...
function f10() {
	input = document.querySelector(".i-10").value;
	document.querySelector(".out-10").style.background = input
}
...
function f12() {
	...
	input = document.querySelector(".i-12").value;
	out.innerHTML = input
}
