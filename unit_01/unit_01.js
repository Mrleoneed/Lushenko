...
document.querySelector(".three").innerHTML = "<div><h3>Произвольный текст</h3></div>"
...
document.querySelector(".four").innerHTML += "<h4>Text</h4> <p>add text</p>"
...
let c = document.querySelector(".five")
c.innerHTML = 3.1415
